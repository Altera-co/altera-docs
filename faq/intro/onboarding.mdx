...
<Note>Wersja do akceptacji. Poniższa mapa łączy instrukcje sprawdzone w QA 21.09.2026. Pełna rejestracja nowego konta i przejście kreatora nowej firmy czekają na osobny test; obecne instrukcje pokazują wejście do tych formularzy. Dostępność czynności zależy od uprawnień i pakietu firmy.</Note>
...
2. [Sprawdź dane firmy i miejsce dodawania nowej](/faq/intro/creating-company). Porównaj dane z dokumentami firmy.
