---
title: "Altera OpenAPI Quickstart: keys, auth, first invoice"
description: "Generate an API key, authenticate requests, and create your first invoice with the Altera OpenAPI. Step-by-step guide for sales and expense endpoints."
---
