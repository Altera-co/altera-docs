...
<Steps>
    <Step icon="building-columns" title="Q1 2024 - Open Banking - Rozliczenia">
        Ta integracja umożliwi klientom bezpośrednie połączenie z ich bankami, co pozwoli na automatyczne pobieranie danych transakcji w celu ułatwienia dokładnego uzgadniania transakcji.
        Integracja zapewnia również uproszczoną metodę dostępu do raportów transakcji w formacie MT940, usuwając kolejne bariery danych wymaganych co miesiąc od klientów księgowych.
    ...
    <Step icon="robot" title="Q2 2025 - Nowa wersja systemu OCR">
        Chcemy być co raz bliżej ideału, dlatego pracujemy nad nową wersją systemu OCR, która pozwoli na jeszcze szybsze i dokładniejsze rozpoznawanie danych z faktur.
        Wprowadzamy też możliwość konfiguracji czy zależy Ci na szybkości i preferujesz otrzymać w fakturze dane podzielone wyłącznie per stawka VAT, czy też dokładności i chcesz otrzymać dane podzielone na poszczególne pozycje.
    </Step>
