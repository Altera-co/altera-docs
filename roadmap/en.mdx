...
<Steps>
    <Step icon="building-columns" title="Q1 2025 - Open Banking - Renumerations">
    ...
    <Step icon="robot" title="Q1 2025 - New OCR System Version">
        We are working on a new version of the OCR system that will allow for even faster and more accurate invoice data recognition. We are also introducing the ability to configure whether you value speed and prefer to receive VAT rate data only in the invoice, or accuracy and want to receive data divided into individual items.
    </Step>
    ...
    <Step icon="truck-fast" title="Q2 2024 - Advanced Auto-Configuration Process">
    ...
    <Step icon="users" title="Q2 2025 - Contractors 2.0">
